  ...
  return (
    ...
    >
      ...
      <div className="relative grid gap-5 md:grid-cols-3">
        ...
        <div className="pointer-events-none absolute top-10 left-[16.7%] right-[16.7%] hidden h-px bg-gradient-to-r from-[hsl(270_80%_55%/0.3)] via-[hsl(270_80%_55%/0.5)] to-[hsl(270_80%_55%/0.3)] md:block" />
