      ...
      <div className="mx-auto w-full max-w-[1400px] space-y-6 p-4 sm:p-5 md:p-8">
        ...
        >
          <div
            ...
            style={{
              background: "linear-gradient(135deg, hsl(234 89% 64% / 0.25), hsl(270 70% 55% / 0.15))",
              boxShadow: "0 0 0 1px hsl(234 89% 64% / 0.3), 0 8px 32px hsl(234 89% 64% / 0.2)",
            }}
          >
            <Wrench className="h-6 w-6" style={{ color: "hsl(234 89% 75%)" }} />
          </div>
          <div>
          ...
          <div className="ml-auto flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold"
            style={{ background: "hsl(160 60% 40% / 0.12)", boxShadow: "0 0 0 1px hsl(160 60% 40% / 0.2)", color: "hsl(160 60% 60%)" }}>
